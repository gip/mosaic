...
export default function ActivityPage() {
  ...
  return <section className="activity-page">
    <div className="page-heading"><div><span className="eyebrow">MOSAIC TRANSACTIONS</span><h2>Activity</h2><p>Trading intents and the on-chain transactions that carry them out.</p></div></div>
